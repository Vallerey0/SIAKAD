        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="users" data-bs-parent="#accordionExample">
                    <li>
                        <a href="./user-profile.html"> Guru </a>
                    </li>
                    <li>
                        <a href="./user-account-settings.html"> Siswa </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="pages" data-bs-parent="#accordionExample">
                    <li>
                        <a href="./pages-knowledge-base.html"> Kelas </a>
                    </li>
                    <li>
                        <a href="./pages-faq.html"> Mata Pelajaran </a>
                    </li>
                    <li>
                        <a href="./pages-contact-us.html" target="_blank"> Jadwal </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="menu">
                ...
                <ul class="collapse submenu list-unstyled" id="authentication" data-bs-parent="#accordionExample">
                    <li>
                        <a href="./auth-boxed-signin.html" target="_blank"> Cetak Jadwal </a>
                    </li>
                </ul>
            </li>
